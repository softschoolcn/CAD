...
//-----------------------------------------------------------------------------
//----- GCommandReactor.h : Declaration of the GCommandReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ GCommandReactor : public AcEditorReactor {

public:
	ACRX_DECLARE_MEMBERS(GCommandReactor) ;
...
public:
	GCommandReactor (const bool autoInitAndRelease =true) ;
	virtual ~GCommandReactor () ;
	...
	GLayerSSGetFilter* m_pFilter;

} ;

#ifdef JDDD_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(GCommandReactor)
#endif
