...
//-----------------------------------------------------------------------------
class CLineCrossReportPanel : public CAcUiDockControlBar {
	DECLARE_DYNAMIC (CLineCrossReportPanel)

public:
	//----- Child dialog which will use the resource id supplied
	CLineCrossReportPanelChildDlg mChildDlg ;

public:
	CLineCrossReportPanel ();
	virtual ~CLineCrossReportPanel ();
