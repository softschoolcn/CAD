...
//-----------------------------------------------------------------------------
//----- CmpReportDockPanel.h : Declaration of the CmpReportDockPanel
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class CmpReportDockPanel : public CAcUiDockControlBar {
	DECLARE_DYNAMIC (CmpReportDockPanel)

public:
	//----- Child dialog which will use the resource id supplied
	CmpReportDialog mChildDlg ;

public:
	CmpReportDockPanel ();
	virtual ~CmpReportDockPanel ();
...
extern CmpReportDockPanel* m_pReportDockPanel;
