...
BEGIN_MESSAGE_MAP(CInPlaceList, CComboBox)
	...
	ON_CONTROL_REFLECT(CBN_SELENDOK, OnSelChanged)
	ON_WM_GETDLGCODE()
...
// void CGridCellCombo::OnClick(CPoint PointCellRelative)
// {
//     m_bEditing = TRUE;
// 
//     CRect rect;
//     CCellID cellId = m_pGrid->GetClickCell();
//     m_pGrid->GetCellRect(cellId, rect);
//     m_pEditWnd = new CInPlaceList(GetGrid(), rect, GetStyle(), IDC_INPLACE_CONTROL, cellId.row, cellId.col, 
//         GetTextClr(), GetBackClr(), m_Strings, GetText(), 1);
// }

void CGridCellCombo::Click(CCellID cellId)
{
    m_bEditing = TRUE;
