...
//-----------------------------------------------------------------------------
class CTextCrossReportPanelChildDlg : public CAcUiDialog {
	DECLARE_DYNAMIC (CTextCrossReportPanelChildDlg)

public:
	CTextCrossReportPanelChildDlg (CWnd *pParent =NULL, HINSTANCE hInstance =NULL) ;

	enum { IDD = IDD_DIALOG_TEXTCROSS} ;
	void OnSizeChanged();
	BOOL OnInitDialog();
...
protected:
	...
	CArray<TextCrossRecord> m_result;
