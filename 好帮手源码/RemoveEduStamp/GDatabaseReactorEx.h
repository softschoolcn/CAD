...
//-----------------------------------------------------------------------------
//----- GDatabaseReactorEx.h : Declaration of the GDatabaseReactorEx
//-----------------------------------------------------------------------------
#pragma once

#ifdef EDUTEST_MODULE
...
class /*DLLIMPEXP*/ GDatabaseReactorEx : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(GDatabaseReactorEx) ;

public:
	GDatabaseReactorEx () ;
	virtual ~GDatabaseReactorEx () ;
	...
	void RemoveEdu(const AcDbDatabase* dwg, const AcDbObject* dbObj);
private:
} ;

#ifdef EDUTEST_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(GDatabaseReactorEx)
#endif
#endif
