...
#pragma comment(lib, "..\\Release\\sys23(X64)\\GGridCtrl.lib")
#pragma comment(lib, "..\\Release\\sys23(X64)\\CADGlobalTools.lib")
#pragma comment(lib, "..\\Release\\sys23(X64)\\CADConfigTools.lib")
#elif _MSC_VER>=1900
#if ARX_MAJOR_VERSION>=22
#pragma comment(lib, "..\\Release\\sys22(X64)\\CADCommTools.lib")
#pragma comment(lib, "..\\Release\\sys22(X64)\\GGridCtrl.lib")
#pragma comment(lib, "..\\Release\\sys22(X64)\\CADGlobalTools.lib")
#pragma comment(lib, "..\\Release\\sys22(X64)\\CADConfigTools.lib")
#else
