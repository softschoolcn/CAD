...
class GRIDCTRL_EXT CGridCellCombo : public CGridCell
{
...
public:
    ...
    void Click(CCellID cellId);
    //void OnClick(CPoint PointCellRelative);
    //void OnClickDown(CPoint PointCellRelative);
...
class GRIDCTRL_EXT CComboEdit : public CEdit
{
// Construction
public:
	CComboEdit();
