...
//-----------------------------------------------------------------------------
//----- GEditorReactor.h : Declaration of the GEditorReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ GEditorReactor : public AcEditorReactor {

public:
	ACRX_DECLARE_MEMBERS(GEditorReactor) ;
...
public:
	GEditorReactor (const bool autoInitAndRelease =true) ;
	virtual ~GEditorReactor () ;
...
#ifdef EDUTEST_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(GEditorReactor)
#endif
#endif
